...
<head>
    ...
    <script src="js/fn_listadomemoadq.js"></script>
    <script>
        <?php 
                            ...
                            <table class="table table-responsive  table-hover">
                                <thead>
                                        <tr>
                                            ...
                                            <th id="tdan" width="10%" class="orden">Analísta</th>
                                            <th id="tdes" width="5%" class="orden">Estado Asig.</th>
                                            <th id="tdfe" width="6%" class="orden">Fecha Entrega Analista</th>
                                            <th id="tdea" width="12%" class="orden">Estado Actual</th>
                                            <th id="tddm" width="5%" class="orden">Dias sin Movimiento</th>
                                            <th id="tdac" width="5%">Acciones</th>
                                        </tr>
                                </thead>
                                <tbody id="listamemos">
                                </tbody>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="overflow:hidden;">
                <div class="modal-header bg-primary">
                    ...
                    <h3 class="modal-title" id="myModalAsiganUsuLabel"><b>Asigna Usuario</b></h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
