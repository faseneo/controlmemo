...
--
-- Servidor: localhost
-- Tiempo de generación: 28-03-2018 a las 12:51:08
...
CREATE TABLE `memo` (
  ...
  `memo_fecha_memo` date DEFAULT NULL,
  `memo_fecha_recepcion` date DEFAULT NULL,
  `memo_memo_estado_id` int(11) NOT NULL,
  `memo_fecha_ingreso` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `memo_depto_id` int(11) NOT NULL,
...
CREATE TABLE `memo_archivo` (
  ...
  `memo_archivo_url` varchar(200) DEFAULT NULL,
...
CREATE TABLE `memo_detalle_archivo` (
  ...
  `memo_det_archivo_url` varchar(200) DEFAULT NULL,
...
CREATE TABLE `memo_tiene_usuario` (
  ...
  `memo_tiene_usu_fecha_asigna` datetime DEFAULT NULL,
  `memo_tiene_usu_estado` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `usuario` (
  ...
  `usuario_password` varchar(10) DEFAULT NULL,
...
ALTER TABLE `centro_costos`
  ADD PRIMARY KEY (`cc_codigo`,`cc_dependencia_codigo`),
...
--
ALTER TABLE `memo`
  ADD PRIMARY KEY (`memo_id`,`memo_memo_estado_id`,`memo_depto_id`),
  ADD KEY `fk_memo_departamento1_idx` (`memo_depto_id`),
...
ALTER TABLE `memo_detalle`
  ADD PRIMARY KEY (`memo_det_id`,`memo_det_proc_compra_id`,`memo_det_proveedor_id`,`memo_det_memo_detalle_estado_id`,`memo_det_memo_id`,`memo_cc_codigo`),
  ...
  ADD KEY `fk_memo_detalle_centro_costos1_idx` (`memo_cc_codigo`);
...
ALTER TABLE `memo`
  ...
  ADD CONSTRAINT `fk_memo_departamento1` FOREIGN KEY (`memo_depto_id`) REFERENCES `departamento` (`dpto_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `memo_detalle`
  ADD CONSTRAINT `fk_memo_detalle_centro_costos1` FOREIGN KEY (`memo_cc_codigo`) REFERENCES `centro_costos` (`cc_codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
